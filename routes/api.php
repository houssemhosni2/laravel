...
Route::get('/notificationecheancec' , 'NotificationController@notificationecheancec');
...
Route::post('register/{role_id}','UserController@register');
Route::post('login/{role_id}','UserController@login');
